...
$(document).ready(function() {
    ...
    var user = {
        ...
        'Pass': '111fe77138e9b8377be349f6429dc567',
        // 'Display': $("#user_asterisk_extension").val(),
        'Display': '203',
        // 'User': $("#user_asterisk_extension").val(),
        'User': '203',
        // 'Realm': $("#asterisk_host").val(),
        'Realm': 'internal.ats.sugare.ru',
        // 'WSServer': 'ws://'+$("#asterisk_host").val()+':8088/ws'
        'WSServer': 'ws://internal.ats.sugare.ru:8088/ws'
    }
    ...
    var Stopwatch = function(elem, options) {
        ...
        function render() {
            ...
            $('#stopwatch').text(moment(clock).format('mm:ss'));
        }
