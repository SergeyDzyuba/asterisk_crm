...
class WebIcqLite_TLV
{
     ...
     * @return string
     */
    public function setTLV($type, $value, $length = false)
    {
        switch ($length) {
            case 1:
                $format = 'c';
     ...
     * @return array
     */
    public function getTLVFragment($data)
    {
...
class WebIcqLite_SNAC extends WebIcqLite_TLV
{
     ...
     * @return string
     */
    public function setSNAC0406($uin, $message)
    {
        $this->request_id++;
        $cookie = microtime();
     ...
     * @return string
     */
    public function setSNAC0406offline($uin, $message)
    {
        $this->request_id++;
        $cookie = microtime();
     ...
     * @return boolean
     */
    public function getSNAC0407($body)
    {
        if (strlen($body)) {
...
class WebIcqLite_FLAP extends WebIcqLite_SNAC
{
     ...
     * Web IcqLite_FLAP
     */
    public function WebIcqLite_FLAP()
    {
     ...
     * parse CookieFLAP
     */
    public function parseCookieFLAP()
    {
        $this->getFLAP();
        $this->info = array();
     ...
     * @return boolean
     */
    public function parseAnswerFLAP()
    {
        $this->getFLAP();
...
class WebIcqLite extends WebIcqLite_FLAP
{
     ...
     * @return object
     */
    public function send_message($uin, $message)
    {
